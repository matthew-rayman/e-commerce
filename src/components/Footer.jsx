...
const Footer = () => {
  return (
    <footer className=' style-2'>
        <div className=" footer-top dark-view py-5">
            <div className=" container">
                <div className="row  justify-content-center row-cols-lg-4 row-cols-sm-2 row-cols-1">
                    <div className="col">
        ...
        <div className=" footer-bottom">
            <div className=" container">
                <div className=" section-wrapper">
                    <p className=' mb-2 mb-lg-0'>&copy; 2023 <Link to="/">Shop Cart</Link> <br className=' d-lg-none' /> Designed by <a href="https://github.com/matthew-rayman">Rayman</a> <br className=' d-lg-none'/> <span className='d-none d-lg-inline'>|</span> Data Provided by <a href="https://github.com/mdalmamunit427">Md Al Mamun</a></p>
